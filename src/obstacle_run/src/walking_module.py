...
class WalkingModule(OP3Module):
    ...
    def __init__(self):
        ...
        # Load configurations
        config_file_path = os.path.join(rospkg.get_pkg_dir('obstacle_run'), 'config', 'walking_configurations.json')
    ...
    def load_configuration(self, file_path):
        ...
        with open(file_path, 'r') as file:
            ...
            # Backward dx, dy, dz, dtheta, period_time
            self.backward_param = {
                'x': configuration['backward']['x_move_amplitude'],
                'y': configuration['backward']['y_move_amplitude'],
                'z': configuration['backward']['z_move_amplitude'],
                'angle': math.radians(configuration['backward']['angle_move_amplitude']),
                'period_time': configuration['backward']['period_time']
            }
    ...
    def backward(self):
        self.__walk(param_name='backward', walking_param=self.backward_param)
